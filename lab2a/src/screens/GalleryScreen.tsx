...
const GalleryScreen: React.FC<Props> = ({navigation}) => {
  ...
  // Завантаження (перший запуск або порожньо)
  ...
  // Помилка (немає інтернету або тільки мобільний інтернет
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 16,
    backgroundColor: '#f5f5f5', // світлий фон усього екрану
  },
  center: {
    flex: 1,
